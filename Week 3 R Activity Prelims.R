...
getwd() #used to display the working directory
setwd("/Users/eduardodischinger/")
...
women_data = data.frame(x1 = c(height),
                      x2 = c(weight)
mean(women_data[,1])
...
height_data<- data.frame(a)
weight_data <- data.frame(b)
